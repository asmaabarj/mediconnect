...
<body class="text-gray-800 font-inter">
    ...
    <nav id="sidebar" class="bg-[#18c29c] z-50 h-screen fixed top-16 left-0 min-w-[250px] py-6 px-4 font-[sans-serif] overflow-auto ">
        <ul class="space-y-3 mt-2">
          <li>
            <a href="javascript:void(0)" class="text-gray-800 text-sm flex gap-4 items-center hover:bg-gray-100 rounded px-4 py-3 transition-all">
          ...
          <li>
            <a href="{{ route('PaHistory') }}" class=" text-gray-800 text-sm flex gap-4 items-center hover:bg-gray-100 rounded px-4 py-3 transition-all">
        ...
        <path
          ...
          <li>
            <a href="javascript:void(0)" class="text-gray-800 text-sm flex items-center hover:bg-gray-100 rounded px-4 py-3 transition-all">
