                            ...
                            <div
                                ...
                                <div
                                    ...
                                    @if ($editspecialite !== null)
                                        ...
                                        <form action="/apahUpdate" method="POST">
                                        @else
                                        ...
                                        <div class="sm:flex sm:items-start">
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                @if ($editspecialite !== null)
                                                    ...
                                                    <input type="hidden" value="{{ $editspecialite->id }}"
                                                        name="specialite_id">
                                                @else
                                                    <h3 class="text-lg leading-6 font-medium text-gray-900"
                                                        id="modal-title">
                                                ...
                                                <input type="text" name="name" id="name"
                                                    value="{{ $editspecialite ? $editspecialite->name : '' }}"
                            ...
                            <div
                                ...
                                <div
                                    ...
                                    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                        <div class="sm:flex sm:items-start">
                                            ...
                                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                                ...
                                                @if ($editmedicament !== null)
                                                    <script>
                                                        document.getElementById('addMedicamentModal').classList.remove('hidden')
                                                    </script>
                                                    <form action="/medcamentUpdate" method="POST" class="mt-8">
                                                    @else
                                                ...
                                                <input type="text" name="MedicamentName" id="MedicamentName"
                                                    value="{{ $editmedicament ? $editmedicament->name : '' }}"
                                                    class="mt-1 p-2 block w-full border-gray-300 rounded-md"
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                                        ...
                                        @if ($editmedicament !== null)
                                            <input type="hidden" value="{{ $editmedicament->id }}"
                                                name="medicament_id">
                                            <button id="" type="submit"
                                                class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-[#18c29c] text-base font-medium text-white hover:bg-[#18c29c] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 sm:ml-3 sm:w-auto sm:text-sm">
                                                Update Medicament
                                ...
                                <tbody class="whitespace-nowrap">
                                    @foreach ($specialities as $speciality)
                                        <tr class="odd:bg-blue-50">
                                            ...
                                            <td class="px-6 py-3">
                                                <div class="flex">
                                                    <form method="POST" action="{{ route('editeSpeciality') }}">
                                                        @csrf
                                                        <input type="hidden" name="specialite_id"
                                                            value="{{ $speciality->id }}">
                                ...
                                @foreach ($medicaments as $medicament)
                                    <tr class="odd:bg-blue-50">
                                        ...
                                        <td class="px-6 py-3 text-sm">
                                            <div class="flex items-center cursor-pointer">
                                                <div class="ml-4">
                                                    <p class="text-sm text-black">{{ $medicament->specialite->name }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
