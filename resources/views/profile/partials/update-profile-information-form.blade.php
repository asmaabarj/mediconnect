<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="email" name="email" type="email" class="mt-1 block w-full border-[2px] border-solid border-black outline-none pl-2 py-2" :value="old('email', $user->email)" required autocomplete="username" />
